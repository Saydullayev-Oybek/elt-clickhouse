...
def transform_transaction():
    ...
    create_table_query = """
        CREATE TABLE IF NOT EXISTS `transformed_proxima`.transaction(
    ...
    data_query = """
        ...
        LEFT JOIN `transformed_proxima`.transaction t ON o.order_id = t.transaction_id
    ...
    if not orders.empty:
        ...
        client.insert_df('transformed_proxima.transaction', expanded_df)